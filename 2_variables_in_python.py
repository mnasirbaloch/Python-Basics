...
#we can't declare a variable without assigning it a value in python  as the following
#command will generate error
t
...
#we can convert one type into another type using different built-in appropriate function for example,
